...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  Answers:
  Making sure the code is clear so you and peer reviewers understand.
  Make sure the code runs well so you and the peer reviewers do not have problems.
  Make sure the code is done in a neat order so you and the peer reviewer can see the flow of the code.
...
- We have an awful lot of computers here, and it gets pretty confusing with
  ...
  Answers:
  It improves the portability allowing you to easily and run applications on different environments such as your local desktop.
  Containers are considered lightweight, starting in less than a second, giving them speed.
  Containers use up less resources as they do not require a separate operating system. This makes it possible to run many more containers than example VM's.
